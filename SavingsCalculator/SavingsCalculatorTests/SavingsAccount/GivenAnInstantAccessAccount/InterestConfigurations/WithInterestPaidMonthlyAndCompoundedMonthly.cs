...
namespace SavingsCalculatorTests.SavingsAccount.GivenAnInstantAccessAccount.InterestConfigurations
{
    ...
    [Parallelizable]
    public class WithInterestPaidMonthlyAndCompoundedMonthly
    {
        ...
        public WithInterestPaidMonthlyAndCompoundedMonthly(double aer, double openingBalance, int monthsOpen, double expectedBalance, double expectedInterest)
        {
