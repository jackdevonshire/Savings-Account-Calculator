...
namespace SavingsCalculatorTests.SavingsAccount.GivenAnInstantAccessAccount.InterestConfigurations
{
    ...
    [TestFixture(5, 100, 3, 100, 0)]
    [TestFixture(5, 100, 6, 100, 0)]
    [TestFixture(5, 100, 24, 110, 10)]
    [TestFixture(5, 100, 36, 116, 16)]
    [TestFixture(5, 100, 48, 122, 22)]
    
    [Parallelizable]
    public class WithInterestPaidAnnuallyAndCompoundedAnnually
    {
        ...
        public WithInterestPaidAnnuallyAndCompoundedAnnually(double aer, double openingBalance, int monthsOpen, double expectedBalance, double expectedInterest)
        {
