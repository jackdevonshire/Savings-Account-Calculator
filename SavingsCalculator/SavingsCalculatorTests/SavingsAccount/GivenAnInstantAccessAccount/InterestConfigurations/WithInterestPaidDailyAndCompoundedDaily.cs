...
namespace SavingsCalculatorTests.SavingsAccount.GivenAnInstantAccessAccount.InterestConfigurations
{
    ...
    [Parallelizable]
    public class WithInterestPaidDailyAndCompoundedDaily
    {
        ...
        public WithInterestPaidDailyAndCompoundedDaily(double aer, double openingBalance, int monthsOpen, double expectedBalance, double expectedInterest)
        {
